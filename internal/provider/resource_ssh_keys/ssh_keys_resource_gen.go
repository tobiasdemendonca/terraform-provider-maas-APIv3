	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"key": schema.StringAttribute{
				Required:            true,
				Description:         "The SSH public key to be added.",
				MarkdownDescription: "The SSH public key to be added.",
			},
			"kind": schema.StringAttribute{
				Computed: true,
				Default:  stringdefault.StaticString("SshKey"),
			},
			"protocol": schema.StringAttribute{
				Computed: true,
			},
			"sshkey_id": schema.Int64Attribute{
				Optional: true,
				Computed: true,
			},
		},
...
type SshKeysModel struct {
	...
	SshkeyId types.Int64   `tfsdk:"sshkey_id"`
}
